"""
Training script for Random Forest only (faster training)
"""
...
def main():
    ...
    rf_model_path = 'device_classifier_model.pkl'
    classifier.save_model(rf_model_path)
    
    print(f"\nModel Accuracy: {rf_accuracy:.3f}")
    ...
    print(f"Example: python predict_simple.py 'correctly worn/16.mp4'")
